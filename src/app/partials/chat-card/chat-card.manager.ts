...
export class ChatCardManager {
    ...
    private currentOpenedCardID = null;
    ...
    private createComponent<T>(component: Type<IChatCard<T>>, data: T, id: string) {
    ...
    private createCard(component, data, id) {
    ...
    open<T>(component: Type<IChatCard<T>>, data: T, id = AppUtils.generateAlphabeticString(), withButton = true) {
    ...
    toogleCard<T>(component: Type<IChatCard<T>>, data: T, id: string) {
